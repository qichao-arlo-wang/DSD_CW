...
# ACDS 23.1 991 win32 2026.03.11.21:01:23
# ----------------------------------------
...
# ----------------------------------------
# If custom_fp_sub is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "custom_fp_sub"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/custom_fp_sub.vo"
}
